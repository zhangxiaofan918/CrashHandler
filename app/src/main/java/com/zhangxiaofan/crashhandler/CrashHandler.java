...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static final String PATH = Environment.getExternalStorageDirectory() + File.separator + "CrashFolder";
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        if (mDefaultCrashHandler != null) {
            ...
            try {
                //延迟2秒杀进程
                Thread.sleep(2000);
                Toast.makeText(mActivity, "程序出错了~", Toast.LENGTH_SHORT).show();
